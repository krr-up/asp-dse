...
\begin{frame}{Strategies}
	\begin{itemize}
		...
		\lstinputlisting[basicstyle=\small,breaklines=true, firstline=1,lastline=1]{listings.lp}
		\pause
...
\begin{frame}{Heuristics}
	\begin{itemize}
		...
		\lstinputlisting[basicstyle=\small,breaklines=true, firstline=3,lastline=4]{listings.lp}
		\pause
		\lstinputlisting[basicstyle=\small,breaklines=true, firstline=5,lastline=5]{listings.lp}
		\pause
...
\begin{frame}{Heuristics (cntd.)}
	\begin{itemize}
		...
		\item Concept 1
		\lstinputlisting[basicstyle=\small,breaklines=true, firstline=7,lastline=7]{listings.lp}
		\pause
		\item Concept 2
		\lstinputlisting[basicstyle=\small,breaklines=true, firstline=8,lastline=8]{listings.lp}
		\pause
